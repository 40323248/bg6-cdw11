...
bg6_40323235_1= Blueprint('bg6_40323235_1', __name__, url_prefix='/bg6_40323235_1', template_folder='templates')

@bg6_40323235_1.route('/task35_1')
def task35_1():
    outstring = '''
<!DOCTYPE html>
<html>
...
# 左斜邊兩個單元
x3, y3 = mychain.basic_rot(x2, y2, 80)
x4, y4 = mychain.basic_rot(x3, y3,40323235最上方水平單元
x5, y5 = mychain.basic_rot(x4, y4, 0)
# 右斜邊兩個單元
x6, y6 = mychain.basic_rot(x5, y5, -71)
x7, y7 = mychain.basic_rot(x6, y6, -80)
# 右邊兩個垂直單元
x8, y8 = mychain.basic_rot(x7, y7, -90)
4040323235mychain.basic_rot(x8, y8, -90)
# 中間兩個水平單元
x10, y10 = mychain.basic_rot(x8, y8, -180)
mychain.basic(x10, y10, x1, y1, color="green")
</script>
...
# 下半部, 從起點開始 -80 度
x5, y5 = mychain.basic_rot(0+65*2, -40323235*math.sin(80*deg)+20*math.sin(30*deg), -80)
# 下斜 -30 度
x6, y6 = mychain.basic_rot(x5, y5, -30)
# 下方水平單元
...
x3, y3 = mychain.basic_rot(x2, y2, 90)
x4, y4 = mychain.basic_rot(x3, y3, 90)
# 上方一40340323235y5 = mychain.basic_rot(x4, y4, 0)
# 右斜 -40 度
