...
bg6_40323248= Blueprint('bg6_40323248', __name__, url_prefix='/bg6_40323248', template_folder='templates')




@bg6_40323248.route('/task48_1')
def task48_1():
    outstring = '''
<!DOCTYPE html>
<html>
